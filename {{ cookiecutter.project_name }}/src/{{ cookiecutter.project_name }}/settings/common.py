...
AUTH_USER_MODEL = '{{ cookiecutter.project_name }}.User'
...
DATABASES = {
    'default': {
        ...
        'NAME': env('POSTGRES_DB', default='{{ cookiecutter.project_name }}'),
        'USER': env('POSTGRES_USER', default='{{ cookiecutter.project_name }}'),
        'PASSWORD': env('POSTGRES_PASSWORD', default='{{ cookiecutter.project_name }}'),
